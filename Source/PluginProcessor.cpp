...
int TubeDistortionAudioProcessor::getCurrentProgram() { return 0; }
...
void TubeDistortionAudioProcessor::changeProgramName(
    int index, const juce::String &newName) {}

//==============================================================================
void TubeDistortionAudioProcessor::prepareToPlay(double sampleRate,
                                                 int samplesPerBlock) {
  ...
  float drive =
      valueTreeState.getRawParameterValue(PARAM_INPUT_GAIN_ID)->load();
  float outputGain =
      valueTreeState.getRawParameterValue(PARAM_OUTPUT_GAIN_ID)->load();
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool TubeDistortionAudioProcessor::isBusesLayoutSupported(
...
void TubeDistortionAudioProcessor::processBlock(
...
//==============================================================================
void TubeDistortionAudioProcessor::getStateInformation(
...
void TubeDistortionAudioProcessor::setStateInformation(const void *data,
                                                       int sizeInBytes) {
...
TubeDistortionAudioProcessor::createParameterLayout() {
...
// Value Tree Listener
void TubeDistortionAudioProcessor::parameterChanged(
